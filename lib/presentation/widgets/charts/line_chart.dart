...
class HavkaLineChartPainter extends CustomPainter {
  ...
  final Function(num) verticalAxisLabelsFormat;
  final Function(num) horizontalAxisLabelsFormat;
  ...
  HavkaLineChartPainter({
    ...
    required this.verticalAxisLabelsFormat,
    required this.horizontalAxisLabelsFormat,
    required this.showGridLine,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final areaPaint = Paint()
      ..shader = LinearGradient(
        ...
        colors: [HavkaColors.green.withValues(alpha: 0.3), Colors.transparent],
    ...
    final circlePaint = Paint()
      ..color = HavkaColors.green.withValues(alpha: 0.8)
      ..strokeWidth = 1
      ..style = PaintingStyle.fill;
    ...
    for(int i=firstDate; i<lastDate+1; i++) {
      ...
      if(showGridLine) {
        final verticalLine = Path()
          ..moveTo(
              left + (horizontalStep -
                  (minDateTime == null ? initialData.first.dx
                      .millisecondsSinceEpoch : minDateTime!
                      .millisecondsSinceEpoch)) / normalizedWidth,
      ...
      final TextSpan verticalAxisValueSpan = TextSpan(
        ...
        text: horizontalAxisLabelsFormat(horizontalStep),
        style: TextStyle(
          color: Colors.grey,
          fontSize: 11,
        ),
    ...
    for(double i=lowerBound; i<upperBound+1; i+=verticalStep) {
      ...
      final TextSpan horizontalAxisValueSpan = TextSpan(
        text: verticalAxisLabelsFormat(i),
        style: TextStyle(
          color: Colors.grey,
          fontFamily: 'Arial',
          fontSize: 11,
...
class HavkaLineChart extends StatefulWidget {
  ...
  const HavkaLineChart({
    ...
    this.verticalAxisLabelsFormat = defaultValuesFormat,
    this.horizontalAxisLabelsFormat = defaultValuesFormat,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: HavkaLineChartPainter(
          ...
          verticalAxisLabelsFormat: widget.verticalAxisLabelsFormat,
          horizontalAxisLabelsFormat: widget.horizontalAxisLabelsFormat,
          showGridLine: widget.showGridLine,
      ),
      child: Container(),
    );
  }
