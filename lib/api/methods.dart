...
import 'package:havka/model/user_product_weighting.dart';
...
class ApiRoutes {
  ...
  Future<bool> signUp(String email, String password) async {
    ...
    final http.Response response = await http.post(
      Uri.https(
        Api.host,
        "${Api.prefix}${Api.userService}${Api.authService}${Api.signUp}",
        body,
      ),
      headers: headers,
      body: body,
  ...
  Future<bool> signIn({
    ...
    final http.Response response = await http.post(
      Uri.https(
        Api.host,
        '${Api.prefix}${Api.userService}${Api.authService}${Api.signIn}',
      ),
      headers: headers,
      body: body,
    );
  ...
  Future<bool> tokenVerify() async {
    ...
    final http.Response response = await http.get(
      Uri.https(
        Api.host,
        "${Api.prefix}${Api.userService}${Api.tokenVerify}"
      ),
      headers: headers,
    );
  ...
  Future<bool> tokenUpdate() async {
    ...
    final http.Response response = await http.get(
      Uri.https(
        Api.host,
        "${Api.prefix}${Api.userService}${Api.tokenUpdate}",
      ),
      headers: headers,
    );
  ...
  Future<bool> signInGoogle(String idToken) async {
    ...
    final http.Response response = await http.post(
      Uri.https(
        Api.host,
        "${Api.prefix}${Api.userService}${Api.authService}${Api.signInGoogle}",
      ),
      headers: headers,
  ...
  Future<bool> signInApple(String email) async {
    ...
    final http.Response response = await http.post(
      Uri.https(
        Api.host,
        "${Api.prefix}${Api.userService}${Api.authService}${Api.signInApple}",
      ),
      headers: headers,
      body: jsonEncode(body),
    );
  ...
  Future<UserProfile> updateProfile(UserProfile userProfile) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.patch(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.profileService}id/",
            queryParams
        ),
        headers: headers,
        body: jsonEncode(userProfile.toJson()),
  ...
  Future<bool> getAvailability() async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.get(
        Uri.https(
          Api.host,
          "${Api.prefix}${Api.userService}${Api.me}",
        ),
        headers: headers,
      );
    });
  ...
  Future<List<UserFridgeItem>> getUserFridgeItemsList(UserFridge userFridge) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.get(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.fridgeService}${Api.fridgeItem}",
            queryParams
        ),
        headers: headers,
      );
  ...
  Future<bool> deleteFridgeItem(UserFridgeItem userFridgeItem) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.delete(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.fridgeService}${Api.fridgeItem}id/",
            queryParams
        ),
        headers: headers,
      );
  ...
  Future<Product> getProductByBarcode(String? barcode) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.get(
        Uri.https(
          Api.host,
          "${Api.prefix}${Api.productService}${Api.productByBarcode}$barcode/",
        ),
        headers: headers,
      );
    });
    ...
    final productJson = jsonDecode(utf8.decode(response.bodyBytes));
  ...
  Future<List<Product>> getProductsBySearchingRequest(String request) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.get(
        Uri.https(
          Api.host,
          "${Api.prefix}${Api.productService}${Api.productsByRequest}",
          queryParams,
        ),
        headers: headers,
      );
    ...
    final products = jsonDecode(response.body) as Iterable;
  ...
  Future<List<UserConsumptionItem>> getUserConsumption() async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.get(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.consumptionService}${Api.consumptionUser}",
            queryParams
        ),
        headers: headers,
      );
  ...
  Future<bool> deleteUserConsumption(UserConsumptionItem uci) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.delete(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.consumptionService}${Api.consumptionUser}id/",
            queryParams
        ),
        headers: headers,
      );
  ...
  Future<List<DeviceService>> getDevicesServicesList() async {
    ...
    final http.Response response = await http.get(
      Uri.https(
          Api.host,
          "${Api.prefix}${Api.serviceByName}/info"
      ),
      headers: <String, String>{
        "Content-type": "application/json",
        "Authorization": "Bearer $token"
  ...
  Future<UserFridge> createUserFridge({required UserFridge userFridge}) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.post(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.fridgeService}${Api.fridgeUser}",
            queryParams
        ),
        headers: headers,
  ...
  Future<UserFridge> modifyUserFridge({required UserFridge userFridge}) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.patch(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.fridgeService}${Api.fridgeUser}id/",
            queryParams
        ),
        headers: headers,
  ...
  Future<bool> deleteFridge({required UserFridge userFridge}) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.delete(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.fridgeService}id/",
            queryParams
        ),
        headers: headers,
      );
  ...
  Future<Product> updateProduct(Product product) async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.patch(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.productService}${product.id}/",
            queryParams
        ),
        headers: headers,
        body: jsonEncode(product.toJson()),
  ...
  Future<List<UserProductWeighting>> getWeightingsHistory() async {
    http.Response response = await authorizedRequest(() async {
      ...
      return await http.get(
        Uri.https(
            Api.host,
            "${Api.prefix}${Api.userProductsWeightingsHistory}"
        ),
        headers: <String, String>{
          "Content-type": "application/json",
          "Authorization": "Bearer $token"
