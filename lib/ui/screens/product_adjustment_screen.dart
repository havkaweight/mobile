...
class _ProductAdjustmentScreenState extends State<ProductAdjustmentScreen>
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RoundedTextField(
                            hintText: "Energy",
                            fillColor: HavkaColors.energy.withOpacity(0.2),
                            prefixIcon: Icon(
                              HavkaIcons.energy,
                          ...
                          RoundedTextField(
                            hintText: "Fat",
                            fillColor: HavkaColors.fat.withOpacity(0.2),
                            prefixIcon: Icon(
                              HavkaIcons.fat,
                          ...
                          RoundedTextField(
                            hintText: "Carbs",
                            fillColor: HavkaColors.carbs.withOpacity(0.2),
                            prefixIcon: Icon(
                              HavkaIcons.carbs,
                          ...
                          RoundedTextField(
                            hintText: "Protein",
                            fillColor: HavkaColors.protein.withOpacity(0.2),
                            prefixIcon: Icon(
                              HavkaIcons.protein,
  ...
  Future _adjustProduct() async {
    ...
    if (widget.product != null) {
      await _apiRoutes.updateProduct(product);
    } else {
